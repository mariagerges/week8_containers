...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        if traversal_type == 'preorder':
            ...
            raise ValueError('type' + str(traversal_type) + "isn't supported")
    ...
    def to_list(self, traversal_type):
        ...
        A general programming principle i
        s that a function should return its results
        rather than print them whenever possible.
        If a function returns its results,
        we can always print the returned results if w
        e need to visualize them.
    ...
    def height(self):
        ...
        HINT:
        See how the __len__ method calls its
        helper staticmethod.
        '''
